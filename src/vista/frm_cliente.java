    ...
    private void bt_modificarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_bt_modificarActionPerformed
       ...
       int selectedRow = tbl_datos.getSelectedRow();
        if (selectedRow >= 0) {
            ...
            modelo.setValueAt(txt_nit.getText(), selectedRow, 0);
            modelo.setValueAt(txt_nombres.getText(), selectedRow, 1);
            modelo.setValueAt(txt_apellidos.getText(), selectedRow, 2);
            modelo.setValueAt(txt_direccion.getText(), selectedRow, 3);
            modelo.setValueAt(txt_telefono.getText(), selectedRow, 4);
            modelo.setValueAt(txt_fn.getText(), selectedRow, 5);
